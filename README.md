...
- Bindery: modern book and audiobook download manager; uses `${EBOOK_FOLDER}` for ebooks, `${AUDIOBOOK_FOLDER}` for audiobooks, and `${COMPLETE_DOWNLOADS}` for completed downloads
- Mylar3: comics
